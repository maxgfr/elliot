...
function chooseUniqueRandomData(numberOfData) {
    ...
    |*  the initial array, the elements are chosen randomly.                                     *|
    |*                                                                                           *|
...
function getControlPoints(x0, y0, x1, y1, x2, y2, strength) {
    ...
    |*  This function gives the control points of the bezier curve between 3 points.             *|
    |*  t is the strength of the shape.                                                          *|
    |*                                                                                           *|
    \*********************************************************************************************/
...
function createLegend(canvas, context, array, colorArray) {
    ...
    |*  array must contain the text for the legend (like 20% Température).                       *|
    |*  When taking the values from the database, these values must be transformed before        *|
    |*  setting them to the array.                                                               *|
    |*                                                                                           *|
    \*********************************************************************************************/
